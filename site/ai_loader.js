...
(function () {
    ...
    const FILES = ['fta_kb_data.js?v=1.2', 'sora_kb_data.js?v=0.1', 'stpa_kb_data.js?v=0.3', 'hf_kb_data.js?v=0.2', 'cert_std_kb_data.js?v=0.13', 'ac_library_kb_data.js?v=1.0', 'cfr_ruletext_kb_data.js?v=1.0', 'ai_assistant.js?v=76.71', 'ai_fidelity.js?v=65.25', 'ai_consistency.js?v=1.5'];
    let _loading = null;
