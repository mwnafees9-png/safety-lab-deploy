    ...
    function build() {
        ...
        const fmeaData = [
            ...
            { internalId: id(), fmeaType: 'piece-part', scope: 'system', owningSystemId: 'sys-avi',
              fmeaId: 'FM-AVI-02', part: 'Display processor', mode: 'Symbol memory corruption', localEffect: 'Frame buffer artifacts',
        ...
        zsaData.push(
            ...
            { internalId: id(), zoneId: 'Z-MLGR', desc: 'Right main landing gear wheel well', equip: 'Right brake lines, gear actuator, squat switch, wheel and tire', severity: 'Hazardous', interference: 'Both brake supply lines to this wheel run through one wheel plane', mitigation: 'Wheel-plane fragment envelope applied; lines routed to opposite sides of the strut', housedFunctions: [] },
            ...
            { internalId: id(), zoneId: 'Z-AFTE', desc: 'Aft fuselage equipment bay', equip: 'Static inverter, ELT, oxygen bottle, aft junction box', severity: 'Hazardous', interference: 'Pressurized oxygen bottle adjacent to the aft junction box', mitigation: 'Bottle relief piped overboard; junction box relocated forward of the relief path', housedFunctions: [] },
        ...
        praData.push(
            ...
            { internalId: id(), praId: 'PRA-008', threat: 'Wheel flange or hub fragment release', desc: 'Liberation of a metallic wheel flange or hub fragment on a wheel-plane trajectory, distinct from tire burst.', systems: 'Landing Gear & Braking, Hydraulic Power System', csfl: 'Both brake supply lines to one wheel inside a single fragment plane', mitigation: 'Wheel-plane envelope applied alongside the tire-burst envelope; lines routed to opposite sides of the strut; fuse-plug behavior demonstrated', affectedZones: ['Z-MLGW', 'Z-MLGR'] },
            { internalId: id(), praId: 'PRA-009', threat: 'Hazardous chemical container rupture', desc: 'Rupture of a pressurized oxygen bottle or of a fire-extinguishing container carried in the type design.', systems: 'Environmental Control, Fire Protection', csfl: 'A pressure and chemical environment in a compartment assessed for neither, with occupant exposure governing', mitigation: 'Bottle relief piped overboard; the relief path assessed as a zone; adjacent equipment relocated out of it', affectedZones: ['Z-AFTE', 'Z-CABIN'] },
