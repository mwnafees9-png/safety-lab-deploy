...
(function () {
    ...
    const FAA23 = {
        source: 'FAA AC 23.1309-1E paragraph 8.x — public domain, quoted verbatim (the definitions are common to Classes I–IV; only the numeric objective changes with class)',
        lines: [
            ...
            'Minor: "Failure conditions that would not significantly reduce airplane safety and involve crew actions... within their capabilities... slight reduction in safety margins or functional capabilities, a slight increase in crew workload."',
            ...
            'Hazardous: involves "a large reduction in safety margins or functional capabilities; Physical distress or higher workload such that the flight crew cannot be relied upon to perform their tasks accurately or completely."',
            ...
            'Part 23 note: a failure condition that would prevent continued safe flight and landing is Catastrophic. The class (I–IV) never changes these definitions — it selects the probability objective and the DAL (AC 23.1309-1E Figure 2), which the targets block above carries.'
        ]
    };
    ...
    const SCVTOL = {
        ...
        lines: [
            ...
            'Category Enhanced — Catastrophic: failure conditions expected to result in ONE OR MORE fatalities or flight-crew incapacitation, usually with loss of the aircraft; and any condition that would prevent continued safe flight and landing (to a vertiport). Hazardous: large reduction in margins or capability, or crew distress/excessive workload, or possible SERIOUS injury to an occupant other than the flight crew — but NO fatality reasonably expected (fatalities are excluded from Hazardous for Enhanced).',
    ...
    const ROTOR29 = {
        source: 'FAA AC 29-2C Chg 4 (5/1/2014) AC 29.1309 b.(2), Figure AC 29.1309-2 — public domain, quoted verbatim (transport rotorcraft)',
        lines: [
            'No Effect (b.(2)(i)): "Failure Conditions that would have no effect on safety; for example, Failure Conditions that would not affect the operational capability of the rotorcraft or increase crew workload, however, could result in an inconvenience to the occupants, excluding the flight crew."',
            'Minor (b.(2)(ii)): "Failure conditions which would not significantly reduce rotorcraft safety, and which would involve crew actions that are well within their capabilities." Examples: a slight reduction in safety margins or functional capabilities, a slight increase in crew workload such as routine flight plan changes, or some physical discomfort to occupants.',
            'Major (b.(2)(iii)): "Failure conditions which would reduce the capability of the rotorcraft or the ability of the crew to cope with adverse operating conditions to the extent that there would be, for example, a significant reduction in safety margins or functional capabilities, a significant increase in crew work load or in conditions impairing crew efficiency, physical distress to occupants, possibly including injuries, or physical discomfort to the flight crew."',
            'Hazardous or Severe-Major (b.(2)(iv)): the same reduction in capability to the extent that there would be (A) a large reduction in safety margins or functional capabilities; (B) physical distress or excessive workload such that the flight crew could not be relied on to perform their tasks accurately or completely; or (C) possible serious or fatal injury to a passenger or a cabin crew member, excluding the flight crew. Note: Hazardous conditions can include events manageable by the crew with proper procedures which, if not implemented correctly or in a timely manner, may result in a Catastrophic event.',
            'Catastrophic (b.(2)(v)): "Failure Conditions which would result in multiple fatalities to occupants, fatalities or incapacitation to the flight crew, or result in loss of rotorcraft."',
            'Figure AC 29.1309-2 effect rows — rotorcraft: no effect / slight reduction in functional capabilities or safety margins / significant reduction / large reduction / loss of rotorcraft. Occupants excluding flight crew: inconvenience / physical discomfort / physical distress possibly including injuries / serious or fatal injury to a passenger or cabin crew member (Note 2: only if the condition can be contained to a fatal injury of ONE occupant) / multiple fatalities. Flight crew: no effect / slight workload increase / physical discomfort or significant workload increase / physical distress or excessive workload impairing accurate or complete task performance / fatalities or incapacitation.',
            'Rotorcraft framing (AC 29.1309 b.(4)(iii)(B)): the FHA starts at the rotorcraft operational level, classifies loss, erroneous/misleading and degraded function against the intended operations and their combinations (VFR, IFR, Category A, IFR plus Category A), and the product is a category per system function. Category A: autorotation is NOT continued safe flight and landing (AC 29.1309 a., lightning discussion). Main/tail-rotor, drive-train and ground/air-resonance conditions are classified with these same five classes.'
        ]
    };

    const ROTOR27 = {
        source: 'FAA AC 27-1B Chg 4 (3/31/2014) AC 27.1309 f.(1) — public domain, quoted verbatim (normal rotorcraft); objectives tiered by PS-ASW-27-15 class',
        lines: [
            'Catastrophic (f.(1)(i)): "failure conditions that would prevent continued safe flight and landing."',
            'Hazardous or Severe-Major (f.(1)(ii)): "failure conditions that would reduce the capability of the aircraft or the ability of the crew to cope with adverse operating conditions to the extent that there would be: (A) A large reduction in safety margins or functional capabilities. (B) Physical distress or higher workload such that the flight crew could not be relied on to perform their tasks accurately or completely. (C) Adverse effects on occupants, including serious or potentially fatal injuries, to a small number of those occupants."',
            'Major (f.(1)(iii)): the same reduction in capability to the extent that there would be, for example, a significant reduction in safety margins or functional capabilities, a significant increase in crew workload or in conditions impairing crew efficiency, or discomfort to occupants, possibly including injuries.',
            'Minor (f.(1)(iv)): "failure conditions that would not significantly reduce aircraft safety, and would involve crew actions that are well within their capabilities." Examples: a slight reduction in safety margins or functional capabilities, a slight increase in crew workload such as routine flight plan changes, or some inconvenience to occupants.',
            'No Effect (f.(1)(v)): "failure conditions that do not affect the operational capability of the aircraft or increase crew workload."',
            'Part 27 framing: AC 27-1B d.(2)(ii)(B) gives the five probability terms with ranges (Frequent ≥10^-3; Reasonably Probable 10^-3 to 10^-5; Remote 10^-5 to 10^-7; Extremely Remote 10^-7 to 10^-9; Extremely Improbable ≤10^-9) but NO per-severity table; the per-class objectives come from FAA policy PS-ASW-27-15 (Class I–IV by engine type, occupants and weight) and, identically, from EASA AMC1 27.1309 Table 2 (CS-27 Amdt 10: Class IV Category A; III Cat B ≥6 occupants or >1 814 kg; II Cat B ≤5 occupants ≤1 814 kg; I Cat B ≤2 occupants VFR only) — carried in the targets block above. For non-IFR rotorcraft the AC states the only failure requirement is that no single failure can result in a hazard to the rotorcraft (d.(2)(ii)(B) note). Rotor, drive-train and resonance conditions are classified with these same five classes.'
        ]
    };
    ...
    const API = { rubricFor: rubricFor, FAA25: FAA25, FAA23: FAA23, SCVTOL: SCVTOL, ROTOR27: ROTOR27, ROTOR29: ROTOR29, ENGINE: ENGINE, PROPELLER: PROPELLER, MISSION: MISSION, version: 3 };
