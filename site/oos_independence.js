...
(function () {
    ...
    function safetyCaseHtml(claim) {
        ...
        return '<!doctype html><html><head><meta charset="utf-8"><title>OOS Independence Safety Case</title><style>'
            ...
            + 'h1{font-size:22px;margin:0 0 4px;}h2{font-size:16px;margin:22px 0 8px;border-bottom:1px solid var(--color-border-hair);padding-bottom:4px;}h4{font-size:13px;margin:12px 0 4px;}'
            + '.sub{color:var(--color-text-primary);font-size:11.5px;margin-bottom:14px;}'
            + 'table{border-collapse:collapse;width:100%;font-size:12px;margin:8px 0;}th,td{border:1px solid var(--color-border-hair);padding:5px 8px;text-align:left;vertical-align:top;}th{background:#f7f8fa;font-size:10.5px;text-transform:uppercase;letter-spacing:.03em;}'
            + '.meta{border:1px solid var(--color-border-hair);border-radius:8px;padding:10px 14px;margin:10px 0;font-size:12.5px;}.meta div{padding:2px 0;}'
