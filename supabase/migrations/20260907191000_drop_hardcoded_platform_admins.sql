...
--
-- The old function embedded mwnafees9@gmail.com and waqas.nafees@safetylabaero.com
-- directly in its body, so EVERY customer-hosted install would ship with Safety Lab's
-- personal emails baked in as platform admins. This replaces that with a table each
