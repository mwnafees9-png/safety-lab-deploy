...
check('_SPEC_FCIM asks for the arrays and defines TL/PL by the MAC (one definition, no styles)',
  /"malfunctions": \[MF1, MF2/.test(ai) && /TOTAL LOSS AND PARTIAL LOSS ARE DEFINED BY THE MAC/.test(ai) && /"Total loss of", "Partial loss of"/.test(ai) && !/TL MODELLING STYLES/.test(ai));
