...
// 246 -> 247 (23 Sep 2026): qual_arg.js — the qualitative argument behind a qualitative-only call, ASTM F3230 X2 (proposal P1).
// 245 -> 246 (23 Sep 2026): ub_stimuli.js — integration stimuli for unintended behavior, ARP4754B 4.6.4 (gap G6).
// 244 -> 245 (23 Sep 2026): pa_audit.js — process assurance audits, ARP4754B 5.7 / E.7 (gap G7).
// 243 -> 244 (23 Sep 2026): usoc.js — unsafe system operating conditions, F3061 X2 (gap G5).
// 242 -> 243 (23 Sep 2026): pra_scenarios.js — particular-risk scenarios and the requirement cascade (gap G3).
// 241 -> 242 (23 Sep 2026): ai_audit.js — the audit trail behind every AI draft (gap G10).
// 240 -> 241 (23 Sep 2026): f3061_dal.js — Part 23 SW/AEH DALs per ASTM F3061 Table 1 or ARP4754 (gap G4).
// 239 -> 240 (23 Sep 2026): zsa_record.js — the record behind each zonal finding (gap G9).
// 238 -> 239 (23 Sep 2026): p23_assessment_level.js — Part 23 Assessment Level from F3230 Table 3 (gap G1).
// 237 -> 238 (23 Sep 2026): render_pass.js — one read-only pass per dashboard render / project check.
...
check('script tag count unchanged (247 — qual_arg.js added 23 Sep (qualitative argument per F3230 X2; loads right after ub_stimuli.js); ub_stimuli.js added 23 Sep (integration stimuli for unintended behavior; loads right after pa_audit.js); pa_audit.js added 23 Sep (process assurance audits; loads right after usoc.js); usoc.js added 23 Sep (unsafe system operating conditions; loads right after pra_scenarios.js); pra_scenarios.js added 23 Sep (PRA scenarios + traced requirements; loads right after ai_audit.js); ai_audit.js added 23 Sep (AI call log + per-draft original and edits; loads right after zsa_record.js); f3061_dal.js added 23 Sep (Part 23 DALs per F3061 Table 1; loads right after severity_rubrics.js); zsa_record.js added 23 Sep (who/how/when/status per zonal finding; loads right after p23_assessment_level.js); p23_assessment_level.js added 23 Sep (Part 23 Assessment Level from F3230 Table 3; loads right after render_pass.js); render_pass.js added 23 Sep (one read-only pass per render; loads right after data_change.js); tree_warm.js added 23 Sep (worker warm-up of per-tree facts; loads right after model_checks.js); data_change.js added 23 Sep (shared change detector; loads right after save_watch.js); lazy_render.js added 23 Sep (render only what is on screen; loads right after error_watch.js); secret_store.js added 20 Sep (S8: the one place the page puts a secret); license_modal.js removed 15 Sep when SL-LICENSE-0001 was folded into SL-EULA-0004; …change_journal_sync.js 9 Sep; save_watch.js 13 Sep; error_watch.js 13 Sep)', tags === 247, 'got ' + tags);
