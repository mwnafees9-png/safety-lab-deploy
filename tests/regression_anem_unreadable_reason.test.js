...
check('pins: ai_assistant 76.58 (loader), ai_skills 2.12, ai_loader 8.50', /ai_assistant\.js\?v=76\.58/.test(loader) && /ai_skills\.js\?v=2\.12/.test(idx) && /ai_loader\.js\?v=8\.50/.test(idx));
