...
check('26 skills registered (V1.3: hf.draftlane + hf.improve, the two RAM prose drafters; F15: arch.systems, mac.draft, coffe.draft)', S && Object.keys(S.skills).length === 26);
if (S) {
