...
console.log('\n[6] wiring — ai_assistant.js, severity_axes.js, index.html');
{
  ...
  check('fha_derive.js is loaded after severity_axes.js; pins bumped (severity_axes 1.3, helpers 2.84, bindings 1.36, loader 8.51 -> ai_assistant >= 76.59)', /severity_axes\.js\?v=[0-9.]+" defer><\/script>[\s\S]{0,300}fha_derive\.js\?v=1\.1/.test(idx) && PIN.atLeast(idx, 'severity_axes.js', '1.3') && PIN.atLeast(idx, 'helpers_modules.js', '2.85') && PIN.atLeast(idx, 'bindings_modules.js', '1.36') && PIN.atLeast(idx, 'ai_loader.js', '8.51') && PIN.atLeast(S('ai_loader.js'), 'ai_assistant.js', '76.59')   /* 5 Sep 2026 — floor, not literal (rule 12) */);
