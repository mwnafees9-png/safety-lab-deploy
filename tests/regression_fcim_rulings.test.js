...
console.log('\n[rulings] _SPEC_FCIM carries the 2 Aug doctrine');
{
  ...
  check('implementation-agnostic: component-noun ban with the live wrong/right pairs',
    ...
    /partial loss of yaw control authority/.test(spec) && /Total loss of propulsive thrust/.test(spec));   // 4 Sep 2026 (evening) — plain loss-form; the MAC is in the FHA comments
